...
export default {
  ...
  examples: (
    <div>
      ...
      <h2>3) With Background-Image, Children: Header + FixedContent + Content (Without Tail)</h2>
      <PageContainer>
        <Page
          dataHook="story-page-background-image-header-fixed-content-content"
          children={[header(Breadcrumbs), fixedContent(), content(false)]}
          backgroundImageUrl="https://static.wixstatic.com/media/f0548921c53940ec803dfb1c203e96fe.jpg/v1/fill/w_400,h_100/f0548921c53940ec803dfb1c203e96fe.jpg"
          />
      </PageContainer>

      <h2>4) With Gradient, Children: Header + FixedContent + Content (Without Tail)</h2>
      <PageContainer>
        <Page
          dataHook="story-page-gradient-header-fixed-content-content"
          children={[header(Breadcrumbs), fixedContent(), content(false)]}
          gradientClassName="background-gradient"
          />
      </PageContainer>
